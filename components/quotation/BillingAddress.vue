        ...
        <div class="collpase_item_inner py-4">
            <div class="px-4">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" v-model="addressData.billing_county" />
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                ...
                <div class="btn_primary login_btn btn_black py-2">
                    <button class="px-5" type="button" @click="submitBillingAddress()">Save Billing address</button>
                </div>
            </div>
        </div>
    </form>
...
export default {
    ...
    methods: {
        ...mapActions('quotation', ['addBillingAddress', 'updateCheckoutStep']),
        async findBilling() {
        ...
        preFillAddress(){
            this.addressData.billing_first_name = this.quotationData?.users?.first_name,
            this.addressData.billing_last_name = this.quotationData?.users?.last_name,
            this.addressData.billing_company = this.quotationData?.company_details,
            this.addressData.billing_mobile = this.quotationData?.users?.mobile,
            this.addressData.billing_street1 = this.quotationData?.billing_address[0]?.street1,
            this.addressData.billing_street2 = this.quotationData?.billing_address[0]?.street2,
            this.addressData.billing_city = this.quotationData?.billing_address[0]?.city,
            this.addressData.billing_state = this.quotationData?.billing_address[0]?.state,
            this.addressData.billing_county = this.quotationData?.billing_address[0]?.county,
            this.addressData.billing_postal_code = this.quotationData?.billing_address[0]?.postal_code
        },
        async handleBillingAddressSelected() {
            try {
                ...
                this.addressData.billing_street1 = address.address.line_1,
                    ...
                    this.addressData.billing_county = address.address.country,
        ...
        applyDeliveryAddress() {
            this.addressData.billing_first_name = this.isDelivery.shipping_first_name,
                ...
                this.addressData.billing_county = this.isDelivery.shipping_country,
